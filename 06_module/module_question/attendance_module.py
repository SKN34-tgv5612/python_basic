"""
### 문제 2: **카피바라의 출퇴근 관리 모듈**

카피바라는 팀원들의 출퇴근 시간을 관리하는 프로그램을 작성하고자 합니다. `attendance_module.py`를 생성하고 이를 사용해 아래 요구사항을 구현하세요.
...
if __name__ == "__main__":
    print(record_attendance("카피바라", "9:00"))
    print(record_leave("카피바라","18:00"))
